            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="form-control">
                  ...
                  <input type="text" className="input input-bordered focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all" value={usuarioEnEdicion?.identification || ""} onChange={(e) => setUsuarioEnEdicion({...usuarioEnEdicion, identificacion: e.target.value} as Users)} />
                </div>
                <div className="form-control">
                  <label className="label"><span className="label-text font-semibold text-green-700">Celular</span></label>
                  <input type="text" className="input input-bordered focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all" value={usuarioEnEdicion?.cellphone || ""} onChange={(e) => setUsuarioEnEdicion({...usuarioEnEdicion, celular: e.target.value} as Users)} />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="form-control">
                  ...
                  <input type="date" className="input input-bordered focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all" value={usuarioEnEdicion?.fechaNac?.split('T')[0] || ""} onChange={(e) => setUsuarioEnEdicion({...usuarioEnEdicion, fecha_nacimiento: e.target.value} as Users)} />
                </div>
                <div className="form-control">
                  <label className="label"><span className="label-text font-semibold text-green-700">Cargo</span></label>
                  <select className="select select-bordered focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all" value={usuarioEnEdicion?.cargoId.id || usuarioEnEdicion?.cargoId.name || ""} onChange={(e) => setUsuarioEnEdicion({...usuarioEnEdicion, cargo: e.target.value} as Users)}>
